...
<body class="bg-gray-100">
    <div class="min-h-screen flex flex-col">
        ...
        <div class="flex-grow container mx-auto py-6">
            <h2 class="text-2xl font-semibold mb-6 text-center">News Update</h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                <a href="edit.php?id=<?php echo $row['id'] ?>" class="text-indigo-600 hover:text-indigo-800">
                                    <img src="../../assets/images/edit.png" alt="Logo" width="20" height="20">
                                </a>                           
                            </td>
                            <td class="border px-4 py-2">
                                <a href="delete.php?id=<?php echo $row['id'] ?>" class="text-red-600 hover:text-red-800">
