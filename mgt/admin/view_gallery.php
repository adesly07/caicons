                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="border px-4 py-2">
                                <img src="../../gallery/<?php echo $row['image_url'] ?>" alt="Slide 1" class=" mb-4">
                                <p class="text-black"><?php echo $row['descriptn']; ?></p>
                            </td>
                            <td class="border px-4 py-2">
                                <a href="edit_gallery.php?id=<?php echo $row['id'] ?>" class="text-indigo-600 hover:text-indigo-800">
                                    <img src="../../assets/images/edit.png" alt="Logo" width="20" height="20">
                                </a>                           
                            </td>
                            <td class="border px-4 py-2">
                                <a href="delete_gallery.php?id=<?php echo $row['id'] ?>" class="text-red-600 hover:text-red-800">
