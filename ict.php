...
// Fetch about data
$sql = "SELECT * FROM ict_centre LIMIT 1"; // Fetch only one row for the About Us section
$result = $conn->query($sql);
$about_data = null;
 ...
 <?php include ("header.php"); ?>
    ...
    <div class="container mx-auto p-6">
        ...
        <div id="title" class="text-center bg-white shadow-md rounded-md p-4 mb-1">
            <h1 class="text-3xl font-bold text-gray-800" id="content-title">ICT CENTRE</h1>
        </div>
