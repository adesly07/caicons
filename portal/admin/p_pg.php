...
$sql3 = "SELECT * FROM payment WHERE reg_num = '$reg'";
...
$sql3 = "SELECT * FROM applicant_documents WHERE reg_num = '$reg'";
$result = $conn->query($sql3);
...
$sql = "SELECT * FROM relatives WHERE reg_num = '$reg'";
$result = $conn->query($sql);
$mydata = [];
...
if ($result->num_rows > 0) {
    ...
    echo "<span class = 'text-red-600'>No record found. Add it before printing.</span>";
}
$conn->close();
?>
