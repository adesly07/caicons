...
<body class="bg-gray-100">
    <div class="min-h-screen flex flex-col">
        ...
        <div class="flex-grow container mx-auto py-6">
            <h2 class="text-2xl font-semibold mb-6 text-center">Added Sessions</h2>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <table class="min-w-full table-auto">
                    ...
                    <tbody>
                        <!-- Example Page Rows -->
                        <?php
                            $query = "SELECT * FROM sch_session ORDER BY id DESC";
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                <a href="delete_session.php?id=<?php echo $row['id'] ?>" class="text-red-600 hover:text-red-800">
