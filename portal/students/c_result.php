...
if ($result2->num_rows > 0) {
    ...
    header('location:r_status.php');
} else {
    echo "<script>alert('Sorry, you cannot check result because your school fees payment has not confirmed!'); window.location.href = 'p_course.php';</script>";
}
}
?>
<!DOCTYPE html>
...
<body class="bg-sky-200">
    ...
    <div class="flex items-center justify-center min-h-screen" >
        <div class="w-full max-w-md bg-white rounded-lg shadow-lg p-6">
            <h2 class="text-2xl font-bold text-center mb-6">VIEW RESULT</h2>
            <form method="POST" action="c_result.php">
                ...
                <button type="submit" class="w-full bg-sky-400 text-white font-bold py-2 px-4 rounded hover:bg-sky-300 flex justify-center items-center">
                    <span class="button-text">Check Result</span>
