...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-lg bg-white rounded-lg shadow-lg p-6">
        <h2 class="text-2xl font-bold text-center mb-6">Fund Wallet </h2>
        ...
        <div id="invoiceInfo" class="mb-4 p-4 bg-gray-50 rounded-md">
            ...
            <h3 class="text-gray-800">Registration Number: <?php echo $data['reg_num']; ?></h3>
            <h3 class="text-gray-800">Course: <?php echo $row['course']; ?></h3>
        </div>

        <!-- Add Wallet Form -->
        <form id="walletForm" method="POST" action="f_wallet.php">
            <div class="mb-4">
